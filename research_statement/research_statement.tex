...
\addlinespace
MFG equilibrium existence / uniqueness (Axis~3)
& Med.
& Monotone MFG (Lasry \& Lions, 2007) ensures uniqueness under mild
  convexity conditions; deep Galerkin methods provide a scalable numerical
  fallback. \\
\bottomrule
\end{tabularx}
